...
function renderListSong() {
    let htmls = musics.map(function (music, index) {
        return `
            ...
            <div class="list-check${index} check-hidden"><ion-icon name="checkmark-circle-outline" class="ion-icon"></ion-icon></div>
            <div class="list-add"><ion-icon name="add-circle-outline" class="ion-icon" onclick="addPlaylist(${index})"></ion-icon></div>
            </div>
        `
    })
...
//     let htmls = newMusics(function(music,index) {
//         return `
...
//                 <p class="singer-name">Trình bày: ${singer}</p>
//             </div>
...
function addPlaylist(index) {
    ...
    if (!checkMusic) {
        ...
        document.querySelector(`.list-check${index}`).classList.remove("check-hidden");
        renderListSong();
        renderListPlaying();
        displayMusicPlayer();
    }
